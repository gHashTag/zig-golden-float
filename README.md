...
> **Attribution Notice:** GF16 adopts IBM's DLFloat format (1/6/9, bias=31). The novelty is in the **implementation** (integer-backed `u16`), not the format specification. φ-distance analysis is an **alternative theoretical framework** — IBM arrived at 6:9 via distribution analysis of neural network data (Mellempudi 2021), not through sacred geometry.
